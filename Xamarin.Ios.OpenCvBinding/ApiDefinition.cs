...
namespace Xamarin.Ios.OpenCvBinding
{
	...
	partial interface Constants
	{
		...
		[Field ("opencv2VersionNumber", "__Internal")]
		double opencv2VersionNumber { get; }

		// extern const unsigned char [] opencv2VersionString;
		[Field ("opencv2VersionString", "__Internal")]
		byte[] opencv2VersionString { get; }
	}
	...
	interface Mat
	{
		...
		IntPtr Constructor (int rows, int cols, int type);
		...
		IntPtr Constructor (int rows, int cols, int type, NSData data);
		...
		IntPtr Constructor (int rows, int cols, int type, Scalar scalar);
		...
		IntPtr Constructor (Size2i size, int type, Scalar scalar);
		...
		IntPtr Constructor (NSNumber[] sizes, int type, Scalar scalar);
	...
	interface MatOfFloat4
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (NSNumber[] array);
	...
	interface MatOfPoint2i
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (Point2i[] array);
	...
	interface Double3
	{
		...
		IntPtr Constructor (double v0, double v1, double v2);

		// -(instancetype _Nonnull)initWithVals:(NSArray<NSNumber *> * _Nonnull)vals;
		[Export ("initWithVals:")]
		IntPtr Constructor (NSNumber[] vals);
	...
	interface Range
	{
		...
		IntPtr Constructor (int start, int end);
	...
	interface Size2f
	{
		...
		IntPtr Constructor (Point2f point);
		...
		[Static]
		[Export ("width:height:")]
		Size2f Width (float width, float height);
	...
	interface Point3i
	{
		...
		IntPtr Constructor (int x, int y, int z);

		// -(instancetype _Nonnull)initWithPoint:(Point2i * _Nonnull)point;
		[Export ("initWithPoint:")]
		IntPtr Constructor (Point2i point);
	...
	interface Point3d
	{
		...
		[Export ("initWithPoint:")]
		IntPtr Constructor (Point2d point);
	...
	interface KeyPoint
	{
		...
		IntPtr Constructor (float x, float y, float size, float angle, float response, int octave, int classId);
		...
		IntPtr Constructor (float x, float y, float size, float angle, float response, int octave);
	...
	interface DMatch
	{
		...
		IntPtr Constructor (int queryIdx, int trainIdx, float distance);
		...
		IntPtr Constructor (int queryIdx, int trainIdx, int imgIdx, float distance);
	...
	interface RotatedRect
	{
		...
		IntPtr Constructor (Point2f center, Size2f size, double angle);
	...
	interface ByteVector
	{
		...
		IntPtr Constructor (ByteVector src);
		...
		unsafe IntPtr Constructor (sbyte* array, nint elements);
	...
	interface Rect2f
	{
		...
		[Export ("initWithPoint:point:")]
		IntPtr Constructor (Point2f point1, Point2f point2);

		// -(instancetype _Nonnull)initWithPoint:(Point2f * _Nonnull)point size:(Size2f * _Nonnull)size;
		[Export ("initWithPoint:size:")]
		IntPtr Constructor (Point2f point, Size2f size);
	...
	interface Float6
	{
		...
		IntPtr Constructor (float v0, float v1, float v2, float v3, float v4, float v5);
	...
	interface MatOfKeyPoint
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (KeyPoint[] array);
	...
	interface MatOfRect2i
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (Rect2i[] array);
	...
	interface TermCriteria
	{
		...
		IntPtr Constructor (int type, int maxCount, double epsilon);
	...
	interface Int4
	{
		...
		IntPtr Constructor (int v0, int v1, int v2, int v3);
	...
	interface MatOfDMatch
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (DMatch[] array);
	...
	interface Scalar
	{
		...
		[Export ("initWithV0:v1:v2:v3:")]
		IntPtr Constructor (double v0, double v1, double v2, double v3);
	...
	interface DoubleVector
	{
		...
		[Export ("initWithVector:")]
		IntPtr Constructor (DoubleVector src);

		// -(instancetype _Nonnull)initWithNativeArray:(double * _Nonnull)array elements:(int)elements;
		[Export ("initWithNativeArray:elements:")]
		unsafe IntPtr Constructor (double* array, int elements);
	...
	interface Size2d
	{
		...
		[Static]
		[Export ("width:height:")]
		Size2d Width (double width, double height);
	...
	interface MinMaxLocResult
	{
		...
		IntPtr Constructor (double minVal, double maxVal, Point2i minLoc, Point2i maxLoc);
	}
	...
	interface MatOfPoint3
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (Point3i[] array);
	...
	interface MatOfRotatedRect
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (RotatedRect[] array);
	...
	interface Size2i
	{
		...
		[Static]
		[Export ("width:height:")]
		Size2i Width (int width, int height);
	...
	interface Float4
	{
		...
		[Export ("initWithV0:v1:v2:v3:")]
		IntPtr Constructor (float v0, float v1, float v2, float v3);
	...
	interface MatOfPoint2f
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (Point2f[] array);
	...
	interface MatOfPoint3f
	{
		...
		[Export ("initWithArray:")]
		IntPtr Constructor (Point3f[] array);
	...
	interface Moments
	{
		...
		IntPtr Constructor (double m00, double m10, double m01, double m20, double m11, double m02, double m30, double m21, double m12, double m03);
	...
	interface Imgproc
	{
		...
		[Export ("createLineSegmentDetector")]
		[Verify (MethodToProperty)]
		LineSegmentDetector CreateLineSegmentDetector { get; }
		...
		[Verify (MethodToProperty)]
		GeneralizedHoughBallard CreateGeneralizedHoughBallard { get; }
		...
		[Verify (MethodToProperty)]
		GeneralizedHoughGuil CreateGeneralizedHoughGuil { get; }
	...
	interface Subdiv2D
	{
		...
		[Export ("initWithRect:")]
		IntPtr Constructor (Rect2i rect);
	...
	interface IntelligentScissorsMB
	{
		...
		[Export ("setGradientMagnitudeMaxLimit")]
		[Verify (MethodToProperty)]
		IntelligentScissorsMB SetGradientMagnitudeMaxLimit { get; }
		...
		[Export ("setEdgeFeatureZeroCrossingParameters")]
		[Verify (MethodToProperty)]
		IntelligentScissorsMB SetEdgeFeatureZeroCrossingParameters { get; }
	...
	interface NormalBayesClassifier
	{
		...
		[Export ("create")]
		[Verify (MethodToProperty)]
		NormalBayesClassifier Create { get; }
	...
	interface Photo
	{
		...
		[Export ("createTonemapDrago")]
		[Verify (MethodToProperty)]
		TonemapDrago CreateTonemapDrago { get; }
		...
		[Export ("createTonemapReinhard")]
		[Verify (MethodToProperty)]
		TonemapReinhard CreateTonemapReinhard { get; }
		...
		[Export ("createTonemapMantiuk")]
		[Verify (MethodToProperty)]
		TonemapMantiuk CreateTonemapMantiuk { get; }
		...
		[Export ("createCalibrateDebevec")]
		[Verify (MethodToProperty)]
		CalibrateDebevec CreateCalibrateDebevec { get; }
	...
	interface Dnn
	{
		...
		// +(NSString * _Nonnull)getInferenceEngineBackendType __attribute__((swift_name("getInferenceEngineBackendType()")));
		[Static]
		[Export ("getInferenceEngineBackendType")]
		[Verify (MethodToProperty)]
		string InferenceEngineBackendType { get; }

		// +(NSString * _Nonnull)setInferenceEngineBackendType:(NSString * _Nonnull)newBackendType __attribute__((swift_name("setInferenceEngineBackendType(newBackendType:)")));
		[Static]
	...
	interface Model
	{
		...
		IntPtr Constructor (string model, string config);
		...
		IntPtr Constructor (Net network);
		...
		// -(Model * _Nonnull)setInputScale:(double)scale __attribute__((swift_name("setInputScale(scale:)")));
	...
	interface DictValue
	{
		...
		[Export ("initWithI:")]
		IntPtr Constructor (int i);

		// -(instancetype _Nonnull)initWithP:(double)p;
		[Export ("initWithP:")]
		IntPtr Constructor (double p);
	...
	interface Net
	{
		...
		// -(Layer * _Nonnull)getLayer:(DictValue * _Nonnull)layerId __attribute__((swift_name("getLayer(layerId:)")));
		[Export ("getLayer:")]
		...
		// -(void)setParam:(DictValue * _Nonnull)layer numParam:(int)numParam blob:(Mat * _Nonnull)blob __attribute__((swift_name("setParam(layer:numParam:blob:)")));
		[Export ("setParam:numParam:blob:")]
		void SetParam (DictValue layer, int numParam, Mat blob);

		// -(Mat * _Nonnull)getParam:(DictValue * _Nonnull)layer numParam:(int)numParam __attribute__((swift_name("getParam(layer:numParam:)")));
		[Export ("getParam:numParam:")]
		Mat GetParam (DictValue layer, int numParam);

		// -(Mat * _Nonnull)getParam:(DictValue * _Nonnull)layer __attribute__((swift_name("getParam(layer:)")));
		[Export ("getParam:")]
	...
	interface AgastFeatureDetector
	{
		...
		[Export ("create")]
		[Verify (MethodToProperty)]
		AgastFeatureDetector Create { get; }
	...
	interface BFMatcher
	{
		...
		IntPtr Constructor (NormTypes normType, bool crossCheck);

		// -(instancetype _Nonnull)initWithNormType:(NormTypes)normType;
		[Export ("initWithNormType:")]
		IntPtr Constructor (NormTypes normType);
	...
	interface BOWKMeansTrainer
	{
		...
		IntPtr Constructor (int clusterCount, TermCriteria termcrit, int attempts, int flags);
		...
		IntPtr Constructor (int clusterCount, TermCriteria termcrit, int attempts);
		...
		IntPtr Constructor (int clusterCount, TermCriteria termcrit);

		// -(instancetype _Nonnull)initWithClusterCount:(int)clusterCount;
		[Export ("initWithClusterCount:")]
		IntPtr Constructor (int clusterCount);
	...
	interface FastFeatureDetector
	{
		...
		[Export ("create")]
		[Verify (MethodToProperty)]
		FastFeatureDetector Create { get; }
	...
	// @interface Converters (Mat)
	[Category]
	[BaseType (typeof(Mat))]
	interface Mat_Converters
	{
		...
		IntPtr Constructor (CGImage image, bool alphaExist);
		...
		IntPtr Constructor (UIImage image, bool alphaExist);
	}

	// @interface QuickLook (Mat)
	[Category]
	[BaseType (typeof(Mat))]
	interface Mat_QuickLook
	{
	...
	interface CvAbstractCamera2
	{
		...
		IntPtr Constructor (UIView parent);
	...
	*/[Protocol]
	...
	{
		[Wrap ("WeakDelegate")]
		CvVideoCameraDelegate2 Delegate { get; set; }
	...
	*/[Protocol]
	...
	{
		[Wrap ("WeakDelegate")]
		CvPhotoCameraDelegate2 Delegate { get; set; }
	...
	interface VideoCapture
	{
		...
		IntPtr Constructor (string filename, int apiPreference);
		...
		IntPtr Constructor (string filename, int apiPreference, IntVector @params);

		// -(instancetype _Nonnull)initWithIndex:(int)index apiPreference:(int)apiPreference;
		[Export ("initWithIndex:apiPreference:")]
		IntPtr Constructor (int index, int apiPreference);
		...
		IntPtr Constructor (int index, int apiPreference, IntVector @params);
	...
	interface VideoWriter
	{
		...
		IntPtr Constructor (string filename, int fourcc, double fps, Size2i frameSize, bool isColor);
		...
		IntPtr Constructor (string filename, int fourcc, double fps, Size2i frameSize);
		...
		IntPtr Constructor (string filename, int apiPreference, int fourcc, double fps, Size2i frameSize, bool isColor);
		...
		IntPtr Constructor (string filename, int apiPreference, int fourcc, double fps, Size2i frameSize);
		...
		IntPtr Constructor (string filename, int fourcc, double fps, Size2i frameSize, IntVector @params);
		...
		IntPtr Constructor (string filename, int apiPreference, int fourcc, double fps, Size2i frameSize, IntVector @params);
	...
	interface Calib3d
	{
		...
		[Static]
		[Export ("stereoCalibrateExtended:imagePoints1:imagePoints2:cameraMatrix1:distCoeffs1:cameraMatrix2:distCoeffs2:imageSize:R:T:E:F:perViewErrors:flags:criteria:")]
		double StereoCalibrateExtended (Mat[] objectPoints, Mat[] imagePoints1, Mat[] imagePoints2, Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Size2i imageSize, Mat R, Mat T, Mat E, Mat F, Mat perViewErrors, int flags, TermCriteria criteria);

		// +(double)stereoCalibrateExtended:(NSArray<Mat *> * _Nonnull)objectPoints imagePoints1:(NSArray<Mat *> * _Nonnull)imagePoints1 imagePoints2:(NSArray<Mat *> * _Nonnull)imagePoints2 cameraMatrix1:(Mat * _Nonnull)cameraMatrix1 distCoeffs1:(Mat * _Nonnull)distCoeffs1 cameraMatrix2:(Mat * _Nonnull)cameraMatrix2 distCoeffs2:(Mat * _Nonnull)distCoeffs2 imageSize:(Size2i * _Nonnull)imageSize R:(Mat * _Nonnull)R T:(Mat * _Nonnull)T E:(Mat * _Nonnull)E F:(Mat * _Nonnull)F perViewErrors:(Mat * _Nonnull)perViewErrors flags:(int)flags __attribute__((swift_name("stereoCalibrate(objectPoints:imagePoints1:imagePoints2:cameraMatrix1:distCoeffs1:cameraMatrix2:distCoeffs2:imageSize:R:T:E:F:perViewErrors:flags:)")));
		[Static]
		[Export ("stereoCalibrateExtended:imagePoints1:imagePoints2:cameraMatrix1:distCoeffs1:cameraMatrix2:distCoeffs2:imageSize:R:T:E:F:perViewErrors:flags:")]
		double StereoCalibrateExtended (Mat[] objectPoints, Mat[] imagePoints1, Mat[] imagePoints2, Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Size2i imageSize, Mat R, Mat T, Mat E, Mat F, Mat perViewErrors, int flags);

		// +(double)stereoCalibrateExtended:(NSArray<Mat *> * _Nonnull)objectPoints imagePoints1:(NSArray<Mat *> * _Nonnull)imagePoints1 imagePoints2:(NSArray<Mat *> * _Nonnull)imagePoints2 cameraMatrix1:(Mat * _Nonnull)cameraMatrix1 distCoeffs1:(Mat * _Nonnull)distCoeffs1 cameraMatrix2:(Mat * _Nonnull)cameraMatrix2 distCoeffs2:(Mat * _Nonnull)distCoeffs2 imageSize:(Size2i * _Nonnull)imageSize R:(Mat * _Nonnull)R T:(Mat * _Nonnull)T E:(Mat * _Nonnull)E F:(Mat * _Nonnull)F perViewErrors:(Mat * _Nonnull)perViewErrors __attribute__((swift_name("stereoCalibrate(objectPoints:imagePoints1:imagePoints2:cameraMatrix1:distCoeffs1:cameraMatrix2:distCoeffs2:imageSize:R:T:E:F:perViewErrors:)")));
		[Static]
		[Export ("stereoCalibrateExtended:imagePoints1:imagePoints2:cameraMatrix1:distCoeffs1:cameraMatrix2:distCoeffs2:imageSize:R:T:E:F:perViewErrors:")]
		double StereoCalibrateExtended (Mat[] objectPoints, Mat[] imagePoints1, Mat[] imagePoints2, Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Size2i imageSize, Mat R, Mat T, Mat E, Mat F, Mat perViewErrors);
	...
	interface HOGDescriptor
	{
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins, int _derivAperture, double _winSigma, HistogramNormType _histogramNormType, double _L2HysThreshold, bool _gammaCorrection, int _nlevels, bool _signedGradient);
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins, int _derivAperture, double _winSigma, HistogramNormType _histogramNormType, double _L2HysThreshold, bool _gammaCorrection, int _nlevels);
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins, int _derivAperture, double _winSigma, HistogramNormType _histogramNormType, double _L2HysThreshold, bool _gammaCorrection);
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins, int _derivAperture, double _winSigma, HistogramNormType _histogramNormType, double _L2HysThreshold);
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins, int _derivAperture, double _winSigma, HistogramNormType _histogramNormType);
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins, int _derivAperture, double _winSigma);
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins, int _derivAperture);
		...
		IntPtr Constructor (Size2i _winSize, Size2i _blockSize, Size2i _blockStride, Size2i _cellSize, int _nbins);
		...
		// -(void)detectMultiScale:(Mat * _Nonnull)img foundLocations:(NSMutableArray<Rect2i *> * _Nonnull)foundLocations foundWeights:(DoubleVector * _Nonnull)foundWeights hitThreshold:(double)hitThreshold winStride:(Size2i * _Nonnull)winStride padding:(Size2i * _Nonnull)padding scale:(double)scale finalThreshold:(double)finalThreshold useMeanshiftGrouping:(BOOL)useMeanshiftGrouping __attribute__((swift_name("detectMultiScale(img:foundLocations:foundWeights:hitThreshold:winStride:padding:scale:finalThreshold:useMeanshiftGrouping:)")));
		[Export ("detectMultiScale:foundLocations:foundWeights:hitThreshold:winStride:padding:scale:finalThreshold:useMeanshiftGrouping:")]
		void DetectMultiScale (Mat img, NSMutableArray<Rect2i> foundLocations, DoubleVector foundWeights, double hitThreshold, Size2i winStride, Size2i padding, double scale, double finalThreshold, bool useMeanshiftGrouping);

		// -(void)detectMultiScale:(Mat * _Nonnull)img foundLocations:(NSMutableArray<Rect2i *> * _Nonnull)foundLocations foundWeights:(DoubleVector * _Nonnull)foundWeights hitThreshold:(double)hitThreshold winStride:(Size2i * _Nonnull)winStride padding:(Size2i * _Nonnull)padding scale:(double)scale finalThreshold:(double)finalThreshold __attribute__((swift_name("detectMultiScale(img:foundLocations:foundWeights:hitThreshold:winStride:padding:scale:finalThreshold:)")));
		[Export ("detectMultiScale:foundLocations:foundWeights:hitThreshold:winStride:padding:scale:finalThreshold:")]
		void DetectMultiScale (Mat img, NSMutableArray<Rect2i> foundLocations, DoubleVector foundWeights, double hitThreshold, Size2i winStride, Size2i padding, double scale, double finalThreshold);
	...
	{
		// -(void)setEpsX:(double)epsX __attribute__((swift_name("setEpsX(epsX:)")));
		[Export ("setEpsX:")]
		void SetEpsX (double epsX);

		// -(void)setEpsY:(double)epsY __attribute__((swift_name("setEpsY(epsY:)")));
		[Export ("setEpsY:")]
		...
		// -(NSString * _Nonnull)decode:(Mat * _Nonnull)img points:(Mat * _Nonnull)points straight_qrcode:(Mat * _Nonnull)straight_qrcode __attribute__((swift_name("decode(img:points:straight_qrcode:)")));
		[Export ("decode:points:straight_qrcode:")]
		string Decode (Mat img, Mat points, Mat straight_qrcode);
		...
		// -(NSString * _Nonnull)detectAndDecode:(Mat * _Nonnull)img points:(Mat * _Nonnull)points straight_qrcode:(Mat * _Nonnull)straight_qrcode __attribute__((swift_name("detectAndDecode(img:points:straight_qrcode:)")));
		[Export ("detectAndDecode:points:straight_qrcode:")]
		...
		// -(BOOL)decodeMulti:(Mat * _Nonnull)img points:(Mat * _Nonnull)points decoded_info:(NSMutableArray<NSString *> * _Nonnull)decoded_info straight_qrcode:(NSMutableArray<Mat *> * _Nonnull)straight_qrcode __attribute__((swift_name("decodeMulti(img:points:decoded_info:straight_qrcode:)")));
		[Export ("decodeMulti:points:decoded_info:straight_qrcode:")]
		bool DecodeMulti (Mat img, Mat points, NSMutableArray<NSString> decoded_info, NSMutableArray<Mat> straight_qrcode);
		...
		// -(BOOL)detectAndDecodeMulti:(Mat * _Nonnull)img decoded_info:(NSMutableArray<NSString *> * _Nonnull)decoded_info points:(Mat * _Nonnull)points straight_qrcode:(NSMutableArray<Mat *> * _Nonnull)straight_qrcode __attribute__((swift_name("detectAndDecodeMulti(img:decoded_info:points:straight_qrcode:)")));
		[Export ("detectAndDecodeMulti:decoded_info:points:straight_qrcode:")]
		bool DetectAndDecodeMulti (Mat img, NSMutableArray<NSString> decoded_info, Mat points, NSMutableArray<Mat> straight_qrcode);
	...
	interface Video
	{
		...
		[Export ("createBackgroundSubtractorMOG2")]
		[Verify (MethodToProperty)]
		BackgroundSubtractorMOG2 CreateBackgroundSubtractorMOG2 { get; }
		...
		[Export ("createBackgroundSubtractorKNN")]
		[Verify (MethodToProperty)]
		BackgroundSubtractorKNN CreateBackgroundSubtractorKNN { get; }
	}
	...
	interface FarnebackOpticalFlow
	{
		...
		[Export ("create")]
		[Verify (MethodToProperty)]
		FarnebackOpticalFlow Create { get; }
	}
	...
	interface KalmanFilter
	{
		...
		IntPtr Constructor (int dynamParams, int measureParams, int controlParams, int type);
		...
		IntPtr Constructor (int dynamParams, int measureParams, int controlParams);
		...
		IntPtr Constructor (int dynamParams, int measureParams);
	...
	interface SparsePyrLKOpticalFlow
	{
		...
		[Export ("create")]
		[Verify (MethodToProperty)]
		SparsePyrLKOpticalFlow Create { get; }
	}
	...
	interface VariationalRefinement
	{
		...
		[Export ("create")]
		[Verify (MethodToProperty)]
		VariationalRefinement Create { get; }
	}
}
